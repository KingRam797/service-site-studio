  ...
  proof: {
    ...
    items: [
      ...
      },
      {
        ...
        category: "Film universe · immersive web",
        description: "A cinematic story world presenting an AI future through atmospheric motion, lore, and audience discovery.",
