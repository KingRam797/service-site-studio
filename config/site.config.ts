...
export const siteConfig: SiteConfig = {
  ...
  proof: {
    ...
    items: [
      ...
      },
      {
        ...
        result: "From cut gallery to booked chair",
      },
      {
        title: "Luscious Kreations",
        category: "Party favors · order logic",
        description: "A product-led ordering experience designed around volume, delivery windows, daily capacity, and direct contact.",
        result: "Complex fulfillment made clear",
      },
      {
        title: "Smile Now / Cry Later",
        category: "Recording studio · sessions",
        description: "A sharp artist-facing identity with transparent hourly rates, deposits, rescheduling rules, and session intent.",
  ...
  services: {
    ...
    items: [
      {
        name: "Sites Like Sex",
        description: "A high-impact Proof Page for one clear offer: positioning, services, real work, contact routing, essential search setup, and launch.",
        price: "$499",
      ...
      {
        name: "Kind Coding",
        description: "A Booking Ready build with custom intake, policies, richer proof, conversion tracking, and an owner-ready handoff.",
        price: "$999",
      ...
      {
        name: "Landed AI",
        description: "An Operations Site with scoped payments, capacity rules, data-backed requests, notifications, and custom workflow logic.",
        price: "$1,799+",
  ...
  faqs: [
    ...
    { question: "Can you connect booking, payments, or store tools?", answer: "Yes. Booking, deposits, payments, availability, capacity, and fulfillment logic are scoped into Kind Coding or Landed AI based on what the workflow needs to enforce." },
